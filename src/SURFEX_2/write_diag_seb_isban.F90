...
!
! MEGAN variables
  IF (CHI%SVI%NBEQ>0 .AND. (TRIM(CHI%CPARAMBVOC) == 'MEGAN') .AND. CHI%LCH_BIO_FLUX) THEN  
     YRECFM='ISOPRENE'
     YCOMMENT='Isoprene flux (Kg/m²/s)'
     CALL WRITE_SURF(DUO%CSELECT, HPROGRAM,YRECFM,MGN%XBIOFLX(:),IRESP,HCOMMENT=YCOMMENT)

     YRECFM='PFT1'
     YCOMMENT='Plant functional type 1'
     CALL WRITE_SURF(DUO%CSELECT, HPROGRAM,YRECFM,MGN%XPFT(1,:),IRESP,HCOMMENT=YCOMMENT)

     YRECFM='PFT2'
     YCOMMENT='Plant functional type 2'
     CALL WRITE_SURF(DUO%CSELECT, HPROGRAM,YRECFM,MGN%XPFT(2,:),IRESP,HCOMMENT=YCOMMENT)

     YRECFM='PFT3'
     YCOMMENT='Plant functional type 3'
     CALL WRITE_SURF(DUO%CSELECT, HPROGRAM,YRECFM,MGN%XPFT(3,:),IRESP,HCOMMENT=YCOMMENT)

     YRECFM='PFT4'
     YCOMMENT='Plant functional type 4'
     CALL WRITE_SURF(DUO%CSELECT, HPROGRAM,YRECFM,MGN%XPFT(4,:),IRESP,HCOMMENT=YCOMMENT)

     YRECFM='PFT5'
     YCOMMENT='Plant functional type 5'
     CALL WRITE_SURF(DUO%CSELECT, HPROGRAM,YRECFM,MGN%XPFT(5,:),IRESP,HCOMMENT=YCOMMENT)

     YRECFM='PFT6'
     YCOMMENT='Plant functional type 6'
     CALL WRITE_SURF(DUO%CSELECT, HPROGRAM,YRECFM,MGN%XPFT(6,:),IRESP,HCOMMENT=YCOMMENT)

     YRECFM='PFT7'
     YCOMMENT='Plant functional type 7'
     CALL WRITE_SURF(DUO%CSELECT, HPROGRAM,YRECFM,MGN%XPFT(7,:),IRESP,HCOMMENT=YCOMMENT)

     YRECFM='PFT8'
     YCOMMENT='Plant functional type 8'
     CALL WRITE_SURF(DUO%CSELECT, HPROGRAM,YRECFM,MGN%XPFT(8,:),IRESP,HCOMMENT=YCOMMENT)

     YRECFM='PFT9'
     YCOMMENT='Plant functional type 9'
     CALL WRITE_SURF(DUO%CSELECT, HPROGRAM,YRECFM,MGN%XPFT(9,:),IRESP,HCOMMENT=YCOMMENT)

     YRECFM='PFT10'
     YCOMMENT='Plant functional type 10'
     CALL WRITE_SURF(DUO%CSELECT, HPROGRAM,YRECFM,MGN%XPFT(10,:),IRESP,HCOMMENT=YCOMMENT)

     YRECFM='PFT11'
     YCOMMENT='Plant functional type 11'
     CALL WRITE_SURF(DUO%CSELECT, HPROGRAM,YRECFM,MGN%XPFT(11,:),IRESP,HCOMMENT=YCOMMENT)

     YRECFM='PFT12'
     YCOMMENT='Plant functional type 12'
     CALL WRITE_SURF(DUO%CSELECT, HPROGRAM,YRECFM,MGN%XPFT(12,:),IRESP,HCOMMENT=YCOMMENT)
     
     YRECFM='PFT13'
     YCOMMENT='Plant functional type 13'
     CALL WRITE_SURF(DUO%CSELECT, HPROGRAM,YRECFM,MGN%XPFT(13,:),IRESP,HCOMMENT=YCOMMENT)

     YRECFM='PFT14'
     YCOMMENT='Plant functional type 14'
     CALL WRITE_SURF(DUO%CSELECT, HPROGRAM,YRECFM,MGN%XPFT(14,:),IRESP,HCOMMENT=YCOMMENT)

     YRECFM='PFT15'
     YCOMMENT='Plant functional type 15'
     CALL WRITE_SURF(DUO%CSELECT, HPROGRAM,YRECFM,MGN%XPFT(15,:),IRESP,HCOMMENT=YCOMMENT)

     YRECFM='PFT16'
     YCOMMENT='Plant functional type 16'
     CALL WRITE_SURF(DUO%CSELECT, HPROGRAM,YRECFM,MGN%XPFT(16,:),IRESP,HCOMMENT=YCOMMENT)


     YRECFM='PPFD24'
     YCOMMENT='Average PPFD over the past 24h'
     CALL WRITE_SURF(DUO%CSELECT, HPROGRAM,YRECFM,MGN%XPPFD24(:),IRESP,HCOMMENT=YCOMMENT)

 
     YRECFM='T24'
     YCOMMENT='Average T over the past 24h'
     CALL WRITE_SURF(DUO%CSELECT, HPROGRAM,YRECFM,MGN%XT24(:),IRESP,HCOMMENT=YCOMMENT)
     

     YRECFM='PPFD'
     YCOMMENT='PPFD'
     CALL WRITE_SURF(DUO%CSELECT, HPROGRAM,YRECFM,MGN%XPPFD(:),IRESP,HCOMMENT=YCOMMENT)


     YRECFM='GAMMA_SM'
     YCOMMENT='GAMMA_SM'
     CALL WRITE_SURF(DUO%CSELECT, HPROGRAM,YRECFM,MGN%XGAMMA_SM(:),IRESP,HCOMMENT=YCOMMENT)  


     YRECFM='GAMMA_AGE'
     YCOMMENT='GAMMA_AGE'
     CALL WRITE_SURF(DUO%CSELECT, HPROGRAM,YRECFM,MGN%XGAMMA_AGE(:),IRESP,HCOMMENT=YCOMMENT)


     YRECFM='ACTIVITY_FACTOR'
     YCOMMENT='ACTIVITY_FACTOR'
     CALL WRITE_SURF(DUO%CSELECT, HPROGRAM,YRECFM,MGN%XACTIVITY_FACTOR(:),IRESP,HCOMMENT=YCOMMENT)

          
     YRECFM='GAMMA_CO2'
     YCOMMENT='GAMMA_CO2'
     CALL WRITE_SURF(DUO%CSELECT, HPROGRAM,YRECFM,MGN%XGAMMA_CO2(:),IRESP,HCOMMENT=YCOMMENT)
     
     YRECFM='PCO2'
     YCOMMENT='PCO2'
     CALL WRITE_SURF(DUO%CSELECT, HPROGRAM,YRECFM,MGN%XPCO2(:),IRESP,HCOMMENT=YCOMMENT)
...
DO JP=4,IO%NPATCH
  DO JJ=1,NP%AL(JP)%NSIZE_P
    IMASK = NP%AL(JP)%NR_P(JJ)
    ZWORK(IMASK) = ZWORK(IMASK) + NP%AL(JP)%XPATCH(JJ) * NPE%AL(JP)%XLAI(JJ)
  ENDDO
ENDDO
!
YRECFM='LAI_ISBA'
