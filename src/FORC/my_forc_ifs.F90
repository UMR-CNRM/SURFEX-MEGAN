SUBROUTINE MY_FORC_IFS(HEXPER,KNI,KNPTS,              &
...
! Input file:
!
CHARACTER(LEN=*), PARAMETER       :: YFILE_FORCIN_01 = '../DATA/ifs/Q'  !Humidité
CHARACTER(LEN=*), PARAMETER       :: YFILE_FORCIN_02 = '../DATA/ifs/SSRD'  !rayonnement solaire incident
CHARACTER(LEN=*), PARAMETER       :: YFILE_FORCIN_03 = '../DATA/ifs/T'     !température
CHARACTER(LEN=*), PARAMETER       :: YFILE_FORCIN_04 = '../DATA/ifs/U'     
CHARACTER(LEN=*), PARAMETER       :: YFILE_FORCIN_05 = '../DATA/ifs/V'
CHARACTER(LEN=*), PARAMETER       :: YFILE_FORCIN_06 = '../DATA/ifs/CRR'   !précipitation convective
CHARACTER(LEN=*), PARAMETER       :: YFILE_FORCIN_07 = '../DATA/ifs/SP'    !pression
CHARACTER(LEN=*), PARAMETER       :: YFILE_FORCIN_08 = '../DATA/ifs/STRD'  !rayonnement solaire LW
CHARACTER(LEN=*), PARAMETER       :: YFILE_FORCIN_09 = '../DATA/ifs/LSRR'  !précipitation large scale
CHARACTER(LEN=*), PARAMETER       :: YFILE_FORCIN_10 = '../DATA/ifs/CSFR'  !neige convection
CHARACTER(LEN=*), PARAMETER       :: YFILE_FORCIN_11 = '../DATA/ifs/LSSFR' !neige large scale
CHARACTER(LEN=*), PARAMETER       :: YFILE_FORCIN_12 = '../DATA/ifs/Z'     !orographie
!       
!----------------------------------------------------------------------------
...
!            ------------------------------------
!
IF (LHOOK) CALL DR_HOOK('MODI_MY_FORC_IFS:MY_FORC_IFS',0,ZHOOK_HANDLE)
...
PQA(:,:) = ZQ(:,:)
!
IF (LHOOK) CALL DR_HOOK('MODI_MY_FORC_IFS:MY_FORC_IFS',1,ZHOOK_HANDLE)

!----------------------------------------------------------------------------
END SUBROUTINE MY_FORC_IFS
!==============================================================================
