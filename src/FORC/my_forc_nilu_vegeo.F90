SUBROUTINE MY_FORC_NILU_VEGEO(HEXPER,KNI,KNPTS,              &
...
! Input file:
!
CHARACTER(LEN=*), PARAMETER       :: YFILE_FORCIN_01 = '../DATA/nilu_vegeo/Q'  !Humidité
CHARACTER(LEN=*), PARAMETER       :: YFILE_FORCIN_02 = '../DATA/nilu_vegeo/SSRD'  !rayonnement solaire incident
CHARACTER(LEN=*), PARAMETER       :: YFILE_FORCIN_03 = '../DATA/nilu_vegeo/T'     !température
CHARACTER(LEN=*), PARAMETER       :: YFILE_FORCIN_04 = '../DATA/nilu_vegeo/U'     
CHARACTER(LEN=*), PARAMETER       :: YFILE_FORCIN_05 = '../DATA/nilu_vegeo/V'
CHARACTER(LEN=*), PARAMETER       :: YFILE_FORCIN_06 = '../DATA/nilu_vegeo/CRR'   !précipitation convective
CHARACTER(LEN=*), PARAMETER       :: YFILE_FORCIN_07 = '../DATA/nilu_vegeo/SP'    !pression
CHARACTER(LEN=*), PARAMETER       :: YFILE_FORCIN_08 = '../DATA/nilu_vegeo/STRD'  !rayonnement solaire LW
CHARACTER(LEN=*), PARAMETER       :: YFILE_FORCIN_09 = '../DATA/nilu_vegeo/LSRR'  !précipitation large scale
CHARACTER(LEN=*), PARAMETER       :: YFILE_FORCIN_10 = '../DATA/nilu_vegeo/CSFR'  !neige convection
CHARACTER(LEN=*), PARAMETER       :: YFILE_FORCIN_11 = '../DATA/nilu_vegeo/Z'     !orographie
!       
!----------------------------------------------------------------------------
! Declare variables to translate forcing from obs to surfex atmospheric forcing
!
!
REAL, DIMENSION(KNPTS,KNI) :: ZTA, ZQA, ZQ, ZUA, ZVA, ZSP, ZRG, ZPRECIP_CONV, ZPRECIP_LS, ZSNOW_CONV, ZLG
...
!            ------------------------------------
!
IF (LHOOK) CALL DR_HOOK('MODI_MY_FORC_NILU_VEGEO:MY_FORC_NILU_VEGEO',0,ZHOOK_HANDLE)

KDAY    = 15          ! starting day 

KMONTH  = 06          ! starting month

KYEAR   = 2019        ! starting year
...
PQA(:,:) = ZQ(:,:)
!
IF (LHOOK) CALL DR_HOOK('MODI_MY_FORC_NILU_VEGEO:MY_FORC_NILU_VEGEO',1,ZHOOK_HANDLE)

!----------------------------------------------------------------------------
END SUBROUTINE MY_FORC_NILU_VEGEO
!==============================================================================
