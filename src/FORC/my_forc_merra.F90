SUBROUTINE MY_FORC_MERRA(HEXPER,KNI,KNPTS,              &
...
! Input file:
!
CHARACTER(LEN=*), PARAMETER       :: YFILE_FORCIN_01 = '../DATA/merra/Q'  !Humidité
CHARACTER(LEN=*), PARAMETER       :: YFILE_FORCIN_02 = '../DATA/merra/SSRD'  !rayonnement solaire incident
CHARACTER(LEN=*), PARAMETER       :: YFILE_FORCIN_03 = '../DATA/merra/T'     !température
CHARACTER(LEN=*), PARAMETER       :: YFILE_FORCIN_04 = '../DATA/merra/U'     
CHARACTER(LEN=*), PARAMETER       :: YFILE_FORCIN_05 = '../DATA/merra/V'
CHARACTER(LEN=*), PARAMETER       :: YFILE_FORCIN_06 = '../DATA/merra/CRR'   !précipitation convective
CHARACTER(LEN=*), PARAMETER       :: YFILE_FORCIN_07 = '../DATA/merra/SP'    !pression
CHARACTER(LEN=*), PARAMETER       :: YFILE_FORCIN_08 = '../DATA/merra/STRD'  !rayonnement solaire LW
CHARACTER(LEN=*), PARAMETER       :: YFILE_FORCIN_09 = '../DATA/merra/LSRR'  !précipitation large scale
CHARACTER(LEN=*), PARAMETER       :: YFILE_FORCIN_10 = '../DATA/merra/CSFR' !neige convection
CHARACTER(LEN=*), PARAMETER       :: YFILE_FORCIN_12 = '../DATA/merra/Z'     !orographie
!       
!----------------------------------------------------------------------------
...
!            ------------------------------------
!
IF (LHOOK) CALL DR_HOOK('MODI_MY_FORC_MERRA:MY_FORC_MERRA',0,ZHOOK_HANDLE)
...
PQA(:,:) = ZQ(:,:)
!
IF (LHOOK) CALL DR_HOOK('MODI_MY_FORC_MERRA:MY_FORC_MERRA',1,ZHOOK_HANDLE)

!----------------------------------------------------------------------------
END SUBROUTINE MY_FORC_MERRA
!==============================================================================
