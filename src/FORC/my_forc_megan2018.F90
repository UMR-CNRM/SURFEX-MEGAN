SUBROUTINE MY_FORC_MEGAN2018(HEXPER,KNI,KNPTS,              &
...
! Input file:
!
CHARACTER(LEN=*), PARAMETER       :: YFILE_FORCIN_01 = '../DATA/megan2018/Q'  !Humidité
CHARACTER(LEN=*), PARAMETER       :: YFILE_FORCIN_02 = '../DATA/megan2018/SSRD'  !rayonnement solaire incident
CHARACTER(LEN=*), PARAMETER       :: YFILE_FORCIN_03 = '../DATA/megan2018/T'     !température
CHARACTER(LEN=*), PARAMETER       :: YFILE_FORCIN_04 = '../DATA/megan2018/U'     
CHARACTER(LEN=*), PARAMETER       :: YFILE_FORCIN_05 = '../DATA/megan2018/V'
CHARACTER(LEN=*), PARAMETER       :: YFILE_FORCIN_06 = '../DATA/megan2018/CRR'   !précipitation convective
CHARACTER(LEN=*), PARAMETER       :: YFILE_FORCIN_07 = '../DATA/megan2018/SP'    !pression
CHARACTER(LEN=*), PARAMETER       :: YFILE_FORCIN_08 = '../DATA/megan2018/STRD'  !rayonnement solaire LW
CHARACTER(LEN=*), PARAMETER       :: YFILE_FORCIN_09 = '../DATA/megan2018/LSRR'  !précipitation large scale
CHARACTER(LEN=*), PARAMETER       :: YFILE_FORCIN_10 = '../DATA/megan2018/CSFR'  !neige convection
CHARACTER(LEN=*), PARAMETER       :: YFILE_FORCIN_11 = '../DATA/megan2018/LSSFR' !neige large scale
CHARACTER(LEN=*), PARAMETER       :: YFILE_FORCIN_12 = '../DATA/megan2018/Z'     !orographie
!       
!----------------------------------------------------------------------------
! Declare variables to translate forcing from obs to surfex atmospheric forcing
!
!
REAL, DIMENSION(KNPTS,KNI) :: ZTA, ZQA, ZQ, ZUA, ZVA, ZSP, ZRG, ZPRECIP_CONV, ZPRECIP_LS, ZSNOW_CONV, ZSNOW_LS, ZLG
...
!            ------------------------------------
!
IF (LHOOK) CALL DR_HOOK('MODI_MY_FORC_MEGAN2018:MY_FORC_MEGAN2018',0,ZHOOK_HANDLE)
...
PQA(:,:) = ZQ(:,:)
!
IF (LHOOK) CALL DR_HOOK('MODI_MY_FORC_MEGAN2018:MY_FORC_MEGAN2018',1,ZHOOK_HANDLE)

!----------------------------------------------------------------------------
END SUBROUTINE MY_FORC_MEGAN2018
!==============================================================================
