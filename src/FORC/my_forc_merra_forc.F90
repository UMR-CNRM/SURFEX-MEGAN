SUBROUTINE MY_FORC_MERRA_FORC(HEXPER,KNI,KNPTS,              &
...
! Input file:
!
CHARACTER(LEN=*), PARAMETER       :: YFILE_FORCIN_01 = '../DATA/merra_forc/Q'  !Humidité
CHARACTER(LEN=*), PARAMETER       :: YFILE_FORCIN_02 = '../DATA/merra_forc/SSRD'  !rayonnement solaire incident
CHARACTER(LEN=*), PARAMETER       :: YFILE_FORCIN_03 = '../DATA/merra_forc/T'     !température
CHARACTER(LEN=*), PARAMETER       :: YFILE_FORCIN_04 = '../DATA/merra_forc/U'     
CHARACTER(LEN=*), PARAMETER       :: YFILE_FORCIN_05 = '../DATA/merra_forc/V'
CHARACTER(LEN=*), PARAMETER       :: YFILE_FORCIN_06 = '../DATA/merra_forc/CRR'   !précipitation convective
CHARACTER(LEN=*), PARAMETER       :: YFILE_FORCIN_07 = '../DATA/merra_forc/SP'    !pression
CHARACTER(LEN=*), PARAMETER       :: YFILE_FORCIN_08 = '../DATA/merra_forc/STRD'  !rayonnement solaire LW
CHARACTER(LEN=*), PARAMETER       :: YFILE_FORCIN_09 = '../DATA/merra_forc/LSRR'  !précipitation large scale
CHARACTER(LEN=*), PARAMETER       :: YFILE_FORCIN_10 = '../DATA/merra_forc/CSFR' !neige convection
CHARACTER(LEN=*), PARAMETER       :: YFILE_FORCIN_12 = '../DATA/merra_forc/Z'     !orographie
!       
!----------------------------------------------------------------------------
! Declare variables to translate forcing from obs to surfex atmospheric forcing
!
!
REAL, DIMENSION(KNPTS,KNI) :: ZTA, ZQA, ZQ, ZUA, ZVA, ZSP, ZRG, ZPRECIP_CONV, ZPRECIP_LS, ZSNOW_LS, ZLG
...
!            ------------------------------------
!
IF (LHOOK) CALL DR_HOOK('MODI_MY_FORC_MERRA_FORC:MY_FORC_MERRA_FORC',0,ZHOOK_HANDLE)
...
DO T=1,KNPTS
   DO I=1,KNI
      ...
      READ(20,*)DUMMY,DUMMY,ZSNOW_LS(T,I)
   ENDDO
ENDDO
...
PQA(:,:) = ZQ(:,:)
!
IF (LHOOK) CALL DR_HOOK('MODI_MY_FORC_MERRA_FORC:MY_FORC_MERRA_FORC',1,ZHOOK_HANDLE)

!----------------------------------------------------------------------------
END SUBROUTINE MY_FORC_MERRA_FORC
!==============================================================================
