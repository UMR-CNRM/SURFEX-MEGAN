...
##########################################################
ifdef MNH_MEGAN
FPPFLAGS_MEGAN = -DMNH_MEGAN
#
FPPFLAGS    += $(FPPFLAGS_MEGAN)
endif
...
ifeq "$(VER_CDF)" "CDFCTI"
CDF_PATH?=/usr
INC_NETCDF     = -I${CDF_PATH}/include -I${CDF_PATH}/include/hdf5/serial/
LIB_NETCDF     = -L${CDF_PATH}/lib64 -L${CDF_PATH}/lib/x86_64-linux-gnu/hdf5/serial/ -lnetcdff -lnetcdf -lhdf5_hl -lhdf5 -lsz -lz
