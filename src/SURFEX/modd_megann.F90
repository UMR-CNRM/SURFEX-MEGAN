...
!
  ...
  REAL, POINTER, DIMENSION(:) :: XMECH_MWT              ! molecular weight of species  !jai changé
  ...
  REAL, POINTER, DIMENSION(:) :: XGAMMA_SM                 
  REAL, POINTER, DIMENSION(:) :: XGAMMA_AGE                                          
  REAL, POINTER, DIMENSION(:) :: XACTIVITY_FACTOR
  REAL, POINTER, DIMENSION(:) :: XGAMMA_CO2   
  REAL, POINTER, DIMENSION(:) :: XPCO2                               
...
NULLIFY(YMEGAN%XGAMMA_SM)
NULLIFY(YMEGAN%XGAMMA_CO2)
NULLIFY(YMEGAN%XGAMMA_AGE)
NULLIFY(YMEGAN%XACTIVITY_FACTOR)
NULLIFY(YMEGAN%XPCO2)
YMEGAN%NBIO=0
YMEGAN%NALKA=0
YMEGAN%NALKE=0
YMEGAN%NARO=0
